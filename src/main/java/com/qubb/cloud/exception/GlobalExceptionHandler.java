...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({DirectoryAlreadyExistsException.class, ResourceConflictException.class})
    public ResponseEntity<ProblemDetail> handleResourceConflictExceptions(
